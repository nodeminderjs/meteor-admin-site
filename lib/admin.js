...
Admin = {
  ...
  _init: function() {
    Meteor.startup(function() {
      console.log('Admin._init() - ready()=', Admin.ready());
      if (Meteor.isClient)
...
Router.configure({
  onBeforeAction: function(pause) {
    console.log('***** global onBeforeAction - ' + Admin.ready());
    if (!Admin.ready()) {
      pause();
...
function initRoutes() {
  Router.map(function() {
    ...
    this.route('adminList', {
      ...
      data: function() {
        console.log('*** data - Admin.ready()=', Admin.ready());
      ...
      action: function() {
        console.log('*** action - Admin.ready()=', Admin.ready());
        var collectionName = this.params.name;
